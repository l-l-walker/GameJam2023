        ...
        if (this.baby_alive) {
            ...
            switch (this.babyTrigger) {
                ...
                case "onResource":
                    ...
                    this.babies.health += 1;                                    //Babies health and text increasing
                    this.babies.text = this.babies.health;
                    //If the resource health is equal to 0 and babies health is 50
                    if (this.closest_resource.health === 0 && this.babies.health === 50) {
                ...
                case "FinishResource":
                    ...
                    if (distance <= 50) {
                        ...
                        //Baby health and text updating
                        this.babies.health -= 50;
                        this.babies.text = this.babies.health;
